...
from .backbones.resnet_torch import *
...
# resnet50 backbone for ablation study.
class ft_net_intra_resnet(nn.Module):
    def __init__(self, num_classes, stride=1):
        super(ft_net_intra_resnet, self).__init__()
...
# resnet50 backbone for ablation study.
class ft_net_inter_resnet(nn.Module):
    def __init__(self, num_classes, stride=1):
        super(ft_net_inter_resnet, self).__init__()
